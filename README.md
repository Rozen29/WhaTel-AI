...
*   **Dynamic AI Management:** Admins can manage AI providers and models dynamically via Telegram commands.
...
| `/help_add_provider <name> <apiKey> <displayName>` | Add a new AI provider dynamically. |
| `/help_remove_provider <name>` | Remove an existing AI provider dynamically. |
| `/help_add_model <providerName> <modelName> <text|vision>` | Add a new AI model dynamically. |
| `/help_remove_model <providerName> <modelName>` | Remove an existing AI model dynamically. |
| `/help_set_provider <name>` | Set the active AI provider dynamically. |
| `/help_set_model <providerName> <modelName>` | Set the active AI model dynamically. |
...
## [2025-05-15] Added Features

- All provider/model management Telegram admin commands now use the `/help_` prefix for clarity and to avoid conflicts.
    - `/help_add_provider <name> <apiKey> <displayName>`
    - `/help_remove_provider <name>`
    - `/help_add_model <providerName> <modelName> <text|vision>`
    - `/help_remove_model <providerName> <modelName>`
    - `/help_set_provider <name>`
    - `/help_set_model <providerName> <modelName>`
- Updated the `/help` command to list all new `/help_` admin commands for provider/model management.
- These commands allow dynamic management of AI providers and models via Telegram (admin only).
- Configuration can be done via both environment variables and Telegram commands.
...
*   **Manajemen AI Dinamis:** Admin dapat mengelola provider dan model AI secara dinamis melalui perintah Telegram.
...
| `/help_add_provider <name> <apiKey> <displayName>` | Menambahkan provider AI baru secara dinamis. |
| `/help_remove_provider <name>` | Menghapus provider AI yang ada secara dinamis. |
| `/help_add_model <providerName> <modelName> <text|vision>` | Menambahkan model AI baru secara dinamis. |
| `/help_remove_model <providerName> <modelName>` | Menghapus model AI yang ada secara dinamis. |
| `/help_set_provider <name>` | Mengatur provider AI aktif secara dinamis. |
| `/help_set_model <providerName> <modelName>` | Mengatur model AI aktif secara dinamis. |
...
## [2025-05-15] Fitur Baru

- Semua perintah admin Telegram untuk manajemen provider/model sekarang menggunakan prefix `/help_` untuk kejelasan dan menghindari konflik.
    - `/help_add_provider <name> <apiKey> <displayName>`
    - `/help_remove_provider <name>`
    - `/help_add_model <providerName> <modelName> <text|vision>`
    - `/help_remove_model <providerName> <modelName>`
    - `/help_set_provider <name>`
    - `/help_set_model <providerName> <modelName>`
- Perintah `/help` diperbarui untuk mencantumkan semua perintah admin baru `/help_` untuk manajemen provider/model.
- Perintah ini memungkinkan pengelolaan provider dan model AI secara dinamis melalui Telegram (hanya admin).
- Konfigurasi dapat dilakukan melalui variabel lingkungan dan perintah Telegram.

Lihat detail penggunaan dan contoh di bawah ini.
